...
<div class="py-6">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg p-6">
            <h1 class="text-2xl font-semibold text-gray-900 dark:text-white mb-6">Edit Announcement</h1>
            ...
            <form action="{{ route('barangay.announcements.update', $announcement) }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <select name="category" id="category" required
                            ...
                            <option value="notice" {{ old('category', $announcement->category) == 'notice' ? 'selected' : '' }}>Notice</option>
                        </select>
                    </div>
                ...
                <div class="mb-6">
                    <label class="flex items-center">
                        <input type="checkbox" name="is_featured" value="1" {{ old('is_featured', $announcement->is_featured) ? 'checked' : '' }}
