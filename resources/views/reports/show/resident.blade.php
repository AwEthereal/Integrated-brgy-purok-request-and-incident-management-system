...
<div class="py-6">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Resident Profile</h1>
                <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">View detailed resident information</p>
            </div>
            <a href="{{ route('reports.residents') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white font-medium rounded-md transition-colors duration-150">
                    ...
                    <div class="flex-shrink-0">
                        <div class="h-20 w-20 rounded-full bg-white flex items-center justify-center shadow-lg">
                            <span class="text-green-600 font-bold text-2xl">
                                {{ strtoupper(substr($user->first_name ?? 'R', 0, 1)) }}{{ strtoupper(substr($user->last_name ?? 'N', 0, 1)) }}
                            </span>
                        </div>
                    </div>
                    <div class="ml-6">
                        <h2 class="text-2xl font-bold text-white">{{ $user->name }}</h2>
                        <p class="text-green-100">Resident</p>
                        <div class="mt-2">
                            @if($user->is_approved)
            ...
            <div class="px-6 py-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-900 dark:text-white">{{ $user->civil_status ? format_label($user->civil_status) : 'N/A' }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="px-6 py-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <p class="mt-1 text-sm text-gray-900 dark:text-white font-semibold">{{ $user->purok->name ?? 'Not Assigned' }}</p>
                    </div>
                    <div class="md:col-span-2">
