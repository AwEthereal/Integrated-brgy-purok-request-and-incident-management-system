        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                ...
                <div class="mb-4 p-4 bg-blue-50 dark:bg-blue-900 border-l-4 border-blue-500 text-blue-700 dark:text-blue-200">
                    <p class="text-sm">Select purok leaders to print or click "Print All" to generate a report for all leaders.</p>
                </div>
                ...
                <div class="mb-4">
                    <div class="relative">
                        <input type="text" 
                               id="searchInput" 
                               placeholder="Search by name, purok, contact..." 
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <thead class="bg-gray-50 dark:bg-gray-700">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Appointed</th>
                                </tr>
                            </thead>
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                @forelse($leaders as $leader)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                        ...
                                        <td class="px-6 py-4 text-sm">
                                            <div class="text-gray-900 dark:text-white">{{ $leader->email }}</div>
                                            <div class="text-gray-500 dark:text-gray-400 text-xs">{{ $leader->contact_number ?? 'No phone' }}</div>
                                        </td>
                                        <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-300">
                                            {{ $leader->address ?? 'No address provided' }}
                                        </td>
                                        <td class="px-6 py-4 text-sm text-gray-500 dark:text-gray-300">
...
function printSelected() {
    ...
    if (selected.length === 0) {
        alert('Please select at least one purok leader to print.');
        return;
    }
    document.getElementById('printForm').submit();
}
