    ...
    <div class="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8">
        ...
        <div class="bg-gray-800 dark:bg-gray-900 rounded-lg shadow-md p-3 sm:p-6 mb-4 sm:mb-8">
            <div class="flex items-start justify-between gap-3">
                ...
                <a href="{{ '/' . ltrim(route('public.landing', [], false), '/') }}" class="inline-flex items-center px-3 py-2 rounded-lg bg-white/10 hover:bg-white/20 text-white text-sm font-medium focus:outline-none focus:ring-2 focus:ring-white/40 flex-shrink-0">
