...
@section('title', 'Add Purok Leader')

@section('content')
<div class="py-6">
  <div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8">
    <h1 class="text-2xl font-semibold mb-4">Add Purok Leader</h1>

    <form method="POST" action="{{ route('secretary.purok-leaders.store') }}" class="space-y-6 bg-white dark:bg-gray-800 p-6 rounded-xl shadow border border-gray-200 dark:border-gray-700">
      @csrf
